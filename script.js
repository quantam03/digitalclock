...
function makeDive() {
    ...
    document.getElementById("dynamic-block").innerHTML="Breakfast Time : "+ value+"<br/><br/> Lunch Time :"+ invalue1.options[invalue1.selectedIndex].text+" <br/><br/>Nap Time :"+ invalue2.options[invalue2.selectedIndex].text;
    }
